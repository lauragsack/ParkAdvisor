...
urlpatterns = [
    ...
    path('parks/<int:parks_id>/edit_review/<int:review_id>/', views.reviews_update, name='reviews_update'),
    path('parks/<int:parks_id>/delete_review/<int:review_id>/', views.reviews_delete, name='reviews_delete'),
